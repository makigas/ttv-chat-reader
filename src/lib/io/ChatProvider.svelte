<script lang="ts">
  ...
  import { deleteMessagePayload, messages, newMessagePayload, popMessagePayload, pushMessagePayload } from "../stores";
  ...
  client.on("message", (channel, tags, message, self) => {
    ...
    messages.update(list => pushMessagePayload(list, {
  ...
  client.on("messagedeleted", (channel, username, deletedMessage, userstate) => {
    ...
    messages.update(list => deleteMessagePayload(list, userstate['target-msg-id']));
  });
